...
//    }
      ...
      for (Boolean isReqSame : booleanList) {
        ...
        Integer initialJobs =
            allEntities
                ...
                .size();
        Integer jobsAdded =
            Utils.getRandomNumber(initialJobs) + 1;
  ...
  public static AllEntities addNewJobsScenario(Driver driver)
    ...
    //Add new jobs
    AllEntities entitiesOfClientForJobGroup = MojoUtils.addNewJobGroupToExistingClient(driver, JobFilterDP.placements, BidLevel.PLACEMENT,
        newJobsToInboundEntity.getJobCreator(), newJobsToInboundEntity);
